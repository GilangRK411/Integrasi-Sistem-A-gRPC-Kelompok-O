...
class ChatServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.UnaryChat = channel.unary_unary(
        ...
        self.ServerStreamingChat = channel.unary_stream(
                '/chat.ChatService/ServerStreamingChat',
                request_serializer=chat__pb2.ChatMessage.SerializeToString,
                response_deserializer=chat__pb2.ChatMessage.FromString,
                _registered_method=True)
        self.ClientStreamingChat = channel.stream_unary(
                '/chat.ChatService/ClientStreamingChat',
                request_serializer=chat__pb2.ChatMessage.SerializeToString,
                response_deserializer=chat__pb2.ChatMessage.FromString,
                _registered_method=True)
        self.BidirectionalChat = channel.stream_stream(
                '/chat.ChatService/BidirectionalChat',
                request_serializer=chat__pb2.ChatMessage.SerializeToString,
                response_deserializer=chat__pb2.ChatMessage.FromString,
                _registered_method=True)
...
def add_ChatServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'UnaryChat': grpc.unary_unary_rpc_method_handler(
                    servicer.UnaryChat,
                    request_deserializer=chat__pb2.ChatMessage.FromString,
                    response_serializer=chat__pb2.ChatMessage.SerializeToString,
            ),
            'ServerStreamingChat': grpc.unary_stream_rpc_method_handler(
                    servicer.ServerStreamingChat,
                    request_deserializer=chat__pb2.ChatMessage.FromString,
                    response_serializer=chat__pb2.ChatMessage.SerializeToString,
            ),
            'ClientStreamingChat': grpc.stream_unary_rpc_method_handler(
                    servicer.ClientStreamingChat,
                    request_deserializer=chat__pb2.ChatMessage.FromString,
                    response_serializer=chat__pb2.ChatMessage.SerializeToString,
            ),
...
class ChatService(object):
    ...
    @staticmethod
    def ServerStreamingChat(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
    ...
    @staticmethod
    def ClientStreamingChat(request_iterator,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
